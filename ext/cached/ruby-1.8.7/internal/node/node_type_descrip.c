...
Node_Type_Descrip node_type_descrips_unsorted[] = {
  ...
  { NODE_ARRAY, NEN_NEXT, NEN_ALEN, NEN_HEAD, "ARRAY" },
  ...
  { NODE_CASE, NEN_NEXT, NEN_BODY, NEN_HEAD, "CASE" },
  ...
  { NODE_OP_ASGN_OR, NEN_VALUE, NEN_AID, NEN_RECV, "OP_ASGN_OR" },
  ...
  { NODE_WHEN, NEN_NEXT, NEN_BODY, NEN_HEAD, "WHEN" },
