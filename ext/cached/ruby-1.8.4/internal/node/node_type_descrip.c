...
Node_Type_Descrip node_type_descrips_unsorted[] = {
  ...
  { NODE_ALLOCA, NEN_VALUE, NEN_CNT, NEN_CFNC, "ALLOCA" },
#endif
  ...
  { NODE_ARRAY, NEN_HEAD, NEN_NEXT, NEN_ALEN, "ARRAY" },
  ...
  { NODE_CASE, NEN_HEAD, NEN_NEXT, NEN_BODY, "CASE" },
  ...
  { NODE_SCOPE, NEN_TBL, NEN_NEXT, NEN_RVAL, "SCOPE" },
  ...
  { NODE_WHEN, NEN_HEAD, NEN_NEXT, NEN_BODY, "WHEN" },
